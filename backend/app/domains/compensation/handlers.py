"""
PayBridge Enterprise Domain: Compensation - Module: Handlers
...
class CompensationHandlersEntity1(BaseModel):
...
class CompensationHandlersEntity2(BaseModel):
...
class CompensationHandlersEntity3(BaseModel):
...
class CompensationHandlersEntity4(BaseModel):
...
class CompensationHandlersEntity5(BaseModel):
...
class CompensationHandlersEntity6(BaseModel):
...
class CompensationHandlersEntity7(BaseModel):
...
class CompensationHandlersEntity8(BaseModel):
...
class CompensationHandlersEntity9(BaseModel):
...
class CompensationHandlersEntity10(BaseModel):
...
class CompensationHandlersEntity11(BaseModel):
...
class CompensationHandlersEntity12(BaseModel):
...
class CompensationHandlersEntity13(BaseModel):
...
class CompensationHandlersEntity14(BaseModel):
...
class CompensationHandlersEntity15(BaseModel):
...
class CompensationHandlersEntity16(BaseModel):
...
class CompensationHandlersEntity17(BaseModel):
...
class CompensationHandlersEntity18(BaseModel):
...
class CompensationHandlersEntity19(BaseModel):
...
class CompensationHandlersEntity20(BaseModel):
...
class CompensationHandlersEntity21(BaseModel):
...
class CompensationHandlersEntity22(BaseModel):
...
class CompensationHandlersEntity23(BaseModel):
...
class CompensationHandlersEntity24(BaseModel):
...
class CompensationHandlersEntity25(BaseModel):
...
class CompensationHandlersEntity26(BaseModel):
...
class CompensationHandlersEntity27(BaseModel):
...
class CompensationHandlersEntity28(BaseModel):
...
class CompensationHandlersEntity29(BaseModel):
...
class CompensationHandlersEntity30(BaseModel):
...
class CompensationHandlersEntity31(BaseModel):
...
class CompensationHandlersEntity32(BaseModel):
...
class CompensationHandlersEntity33(BaseModel):
...
class CompensationHandlersEntity34(BaseModel):
...
class CompensationHandlersEntity35(BaseModel):
...
class CompensationHandlersEntity36(BaseModel):
...
class CompensationHandlersEntity37(BaseModel):
...
class CompensationHandlersEntity38(BaseModel):
...
class CompensationHandlersEntity39(BaseModel):
...
class CompensationHandlersEntity40(BaseModel):
...
class CompensationHandlersEntity41(BaseModel):
...
class CompensationHandlersEntity42(BaseModel):
...
class CompensationHandlersEntity43(BaseModel):
...
class CompensationHandlersEntity44(BaseModel):
...
class CompensationHandlersEntity45(BaseModel):
...
class CompensationHandlersEntity46(BaseModel):
...
class CompensationHandlersEntity47(BaseModel):
...
class CompensationHandlersEntity48(BaseModel):
...
class CompensationHandlersEntity49(BaseModel):
...
class CompensationHandlersEntity50(BaseModel):
...
class CompensationHandlersEntity51(BaseModel):
...
class CompensationHandlersEntity52(BaseModel):
...
class CompensationHandlersEntity53(BaseModel):
...
class CompensationHandlersEntity54(BaseModel):
...
class CompensationHandlersEntity55(BaseModel):
...
class CompensationHandlersEntity56(BaseModel):
...
class CompensationHandlersEntity57(BaseModel):
...
class CompensationHandlersEntity58(BaseModel):
...
class CompensationHandlersEntity59(BaseModel):

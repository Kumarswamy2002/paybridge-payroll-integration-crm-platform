"""
PayBridge Enterprise Domain: Compensation - Module: Schemas
...
class CompensationSchemasEntity1(BaseModel):
...
class CompensationSchemasEntity2(BaseModel):
...
class CompensationSchemasEntity3(BaseModel):
...
class CompensationSchemasEntity4(BaseModel):
...
class CompensationSchemasEntity5(BaseModel):
...
class CompensationSchemasEntity6(BaseModel):
...
class CompensationSchemasEntity7(BaseModel):
...
class CompensationSchemasEntity8(BaseModel):
...
class CompensationSchemasEntity9(BaseModel):
...
class CompensationSchemasEntity10(BaseModel):
...
class CompensationSchemasEntity11(BaseModel):
...
class CompensationSchemasEntity12(BaseModel):
...
class CompensationSchemasEntity13(BaseModel):
...
class CompensationSchemasEntity14(BaseModel):
...
class CompensationSchemasEntity15(BaseModel):
...
class CompensationSchemasEntity16(BaseModel):
...
class CompensationSchemasEntity17(BaseModel):
...
class CompensationSchemasEntity18(BaseModel):
...
class CompensationSchemasEntity19(BaseModel):
...
class CompensationSchemasEntity20(BaseModel):
...
class CompensationSchemasEntity21(BaseModel):
...
class CompensationSchemasEntity22(BaseModel):
...
class CompensationSchemasEntity23(BaseModel):
...
class CompensationSchemasEntity24(BaseModel):
...
class CompensationSchemasEntity25(BaseModel):
...
class CompensationSchemasEntity26(BaseModel):
...
class CompensationSchemasEntity27(BaseModel):
...
class CompensationSchemasEntity28(BaseModel):
...
class CompensationSchemasEntity29(BaseModel):
...
class CompensationSchemasEntity30(BaseModel):
...
class CompensationSchemasEntity31(BaseModel):
...
class CompensationSchemasEntity32(BaseModel):
...
class CompensationSchemasEntity33(BaseModel):
...
class CompensationSchemasEntity34(BaseModel):
...
class CompensationSchemasEntity35(BaseModel):
...
class CompensationSchemasEntity36(BaseModel):
...
class CompensationSchemasEntity37(BaseModel):
...
class CompensationSchemasEntity38(BaseModel):
...
class CompensationSchemasEntity39(BaseModel):
...
class CompensationSchemasEntity40(BaseModel):
...
class CompensationSchemasEntity41(BaseModel):
...
class CompensationSchemasEntity42(BaseModel):
...
class CompensationSchemasEntity43(BaseModel):
...
class CompensationSchemasEntity44(BaseModel):
...
class CompensationSchemasEntity45(BaseModel):
...
class CompensationSchemasEntity46(BaseModel):
...
class CompensationSchemasEntity47(BaseModel):
...
class CompensationSchemasEntity48(BaseModel):
...
class CompensationSchemasEntity49(BaseModel):
...
class CompensationSchemasEntity50(BaseModel):
...
class CompensationSchemasEntity51(BaseModel):
...
class CompensationSchemasEntity52(BaseModel):
...
class CompensationSchemasEntity53(BaseModel):
...
class CompensationSchemasEntity54(BaseModel):
...
class CompensationSchemasEntity55(BaseModel):
...
class CompensationSchemasEntity56(BaseModel):
...
class CompensationSchemasEntity57(BaseModel):
...
class CompensationSchemasEntity58(BaseModel):
...
class CompensationSchemasEntity59(BaseModel):

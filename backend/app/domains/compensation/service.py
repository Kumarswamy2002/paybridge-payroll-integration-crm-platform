"""
PayBridge Enterprise Domain: Compensation - Module: Service
...
class CompensationServiceEntity1(BaseModel):
...
class CompensationServiceEntity2(BaseModel):
...
class CompensationServiceEntity3(BaseModel):
...
class CompensationServiceEntity4(BaseModel):
...
class CompensationServiceEntity5(BaseModel):
...
class CompensationServiceEntity6(BaseModel):
...
class CompensationServiceEntity7(BaseModel):
...
class CompensationServiceEntity8(BaseModel):
...
class CompensationServiceEntity9(BaseModel):
...
class CompensationServiceEntity10(BaseModel):
...
class CompensationServiceEntity11(BaseModel):
...
class CompensationServiceEntity12(BaseModel):
...
class CompensationServiceEntity13(BaseModel):
...
class CompensationServiceEntity14(BaseModel):
...
class CompensationServiceEntity15(BaseModel):
...
class CompensationServiceEntity16(BaseModel):
...
class CompensationServiceEntity17(BaseModel):
...
class CompensationServiceEntity18(BaseModel):
...
class CompensationServiceEntity19(BaseModel):
...
class CompensationServiceEntity20(BaseModel):
...
class CompensationServiceEntity21(BaseModel):
...
class CompensationServiceEntity22(BaseModel):
...
class CompensationServiceEntity23(BaseModel):
...
class CompensationServiceEntity24(BaseModel):
...
class CompensationServiceEntity25(BaseModel):
...
class CompensationServiceEntity26(BaseModel):
...
class CompensationServiceEntity27(BaseModel):
...
class CompensationServiceEntity28(BaseModel):
...
class CompensationServiceEntity29(BaseModel):
...
class CompensationServiceEntity30(BaseModel):
...
class CompensationServiceEntity31(BaseModel):
...
class CompensationServiceEntity32(BaseModel):
...
class CompensationServiceEntity33(BaseModel):
...
class CompensationServiceEntity34(BaseModel):
...
class CompensationServiceEntity35(BaseModel):
...
class CompensationServiceEntity36(BaseModel):
...
class CompensationServiceEntity37(BaseModel):
...
class CompensationServiceEntity38(BaseModel):
...
class CompensationServiceEntity39(BaseModel):
...
class CompensationServiceEntity40(BaseModel):
...
class CompensationServiceEntity41(BaseModel):
...
class CompensationServiceEntity42(BaseModel):
...
class CompensationServiceEntity43(BaseModel):
...
class CompensationServiceEntity44(BaseModel):
...
class CompensationServiceEntity45(BaseModel):
...
class CompensationServiceEntity46(BaseModel):
...
class CompensationServiceEntity47(BaseModel):
...
class CompensationServiceEntity48(BaseModel):
...
class CompensationServiceEntity49(BaseModel):
...
class CompensationServiceEntity50(BaseModel):
...
class CompensationServiceEntity51(BaseModel):
...
class CompensationServiceEntity52(BaseModel):
...
class CompensationServiceEntity53(BaseModel):
...
class CompensationServiceEntity54(BaseModel):
...
class CompensationServiceEntity55(BaseModel):
...
class CompensationServiceEntity56(BaseModel):
...
class CompensationServiceEntity57(BaseModel):
...
class CompensationServiceEntity58(BaseModel):
...
class CompensationServiceEntity59(BaseModel):

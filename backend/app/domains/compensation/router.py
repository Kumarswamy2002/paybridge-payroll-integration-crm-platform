"""
PayBridge Enterprise Domain: Compensation - Module: Router
...
class CompensationRouterEntity1(BaseModel):
...
class CompensationRouterEntity2(BaseModel):
...
class CompensationRouterEntity3(BaseModel):
...
class CompensationRouterEntity4(BaseModel):
...
class CompensationRouterEntity5(BaseModel):
...
class CompensationRouterEntity6(BaseModel):
...
class CompensationRouterEntity7(BaseModel):
...
class CompensationRouterEntity8(BaseModel):
...
class CompensationRouterEntity9(BaseModel):
...
class CompensationRouterEntity10(BaseModel):
...
class CompensationRouterEntity11(BaseModel):
...
class CompensationRouterEntity12(BaseModel):
...
class CompensationRouterEntity13(BaseModel):
...
class CompensationRouterEntity14(BaseModel):
...
class CompensationRouterEntity15(BaseModel):
...
class CompensationRouterEntity16(BaseModel):
...
class CompensationRouterEntity17(BaseModel):
...
class CompensationRouterEntity18(BaseModel):
...
class CompensationRouterEntity19(BaseModel):
...
class CompensationRouterEntity20(BaseModel):
...
class CompensationRouterEntity21(BaseModel):
...
class CompensationRouterEntity22(BaseModel):
...
class CompensationRouterEntity23(BaseModel):
...
class CompensationRouterEntity24(BaseModel):
...
class CompensationRouterEntity25(BaseModel):
...
class CompensationRouterEntity26(BaseModel):
...
class CompensationRouterEntity27(BaseModel):
...
class CompensationRouterEntity28(BaseModel):
...
class CompensationRouterEntity29(BaseModel):
...
class CompensationRouterEntity30(BaseModel):
...
class CompensationRouterEntity31(BaseModel):
...
class CompensationRouterEntity32(BaseModel):
...
class CompensationRouterEntity33(BaseModel):
...
class CompensationRouterEntity34(BaseModel):
...
class CompensationRouterEntity35(BaseModel):
...
class CompensationRouterEntity36(BaseModel):
...
class CompensationRouterEntity37(BaseModel):
...
class CompensationRouterEntity38(BaseModel):
...
class CompensationRouterEntity39(BaseModel):
...
class CompensationRouterEntity40(BaseModel):
...
class CompensationRouterEntity41(BaseModel):
...
class CompensationRouterEntity42(BaseModel):
...
class CompensationRouterEntity43(BaseModel):
...
class CompensationRouterEntity44(BaseModel):
...
class CompensationRouterEntity45(BaseModel):
...
class CompensationRouterEntity46(BaseModel):
...
class CompensationRouterEntity47(BaseModel):
...
class CompensationRouterEntity48(BaseModel):
...
class CompensationRouterEntity49(BaseModel):
...
class CompensationRouterEntity50(BaseModel):
...
class CompensationRouterEntity51(BaseModel):
...
class CompensationRouterEntity52(BaseModel):
...
class CompensationRouterEntity53(BaseModel):
...
class CompensationRouterEntity54(BaseModel):
...
class CompensationRouterEntity55(BaseModel):
...
class CompensationRouterEntity56(BaseModel):
...
class CompensationRouterEntity57(BaseModel):
...
class CompensationRouterEntity58(BaseModel):
...
class CompensationRouterEntity59(BaseModel):

"""
PayBridge Enterprise Domain: Compensation - Module: Models
...
class CompensationModelsEntity1(BaseModel):
...
class CompensationModelsEntity2(BaseModel):
...
class CompensationModelsEntity3(BaseModel):
...
class CompensationModelsEntity4(BaseModel):
...
class CompensationModelsEntity5(BaseModel):
...
class CompensationModelsEntity6(BaseModel):
...
class CompensationModelsEntity7(BaseModel):
...
class CompensationModelsEntity8(BaseModel):
...
class CompensationModelsEntity9(BaseModel):
...
class CompensationModelsEntity10(BaseModel):
...
class CompensationModelsEntity11(BaseModel):
...
class CompensationModelsEntity12(BaseModel):
...
class CompensationModelsEntity13(BaseModel):
...
class CompensationModelsEntity14(BaseModel):
...
class CompensationModelsEntity15(BaseModel):
...
class CompensationModelsEntity16(BaseModel):
...
class CompensationModelsEntity17(BaseModel):
...
class CompensationModelsEntity18(BaseModel):
...
class CompensationModelsEntity19(BaseModel):
...
class CompensationModelsEntity20(BaseModel):
...
class CompensationModelsEntity21(BaseModel):
...
class CompensationModelsEntity22(BaseModel):
...
class CompensationModelsEntity23(BaseModel):
...
class CompensationModelsEntity24(BaseModel):
...
class CompensationModelsEntity25(BaseModel):
...
class CompensationModelsEntity26(BaseModel):
...
class CompensationModelsEntity27(BaseModel):
...
class CompensationModelsEntity28(BaseModel):
...
class CompensationModelsEntity29(BaseModel):
...
class CompensationModelsEntity30(BaseModel):
...
class CompensationModelsEntity31(BaseModel):
...
class CompensationModelsEntity32(BaseModel):
...
class CompensationModelsEntity33(BaseModel):
...
class CompensationModelsEntity34(BaseModel):
...
class CompensationModelsEntity35(BaseModel):
...
class CompensationModelsEntity36(BaseModel):
...
class CompensationModelsEntity37(BaseModel):
...
class CompensationModelsEntity38(BaseModel):
...
class CompensationModelsEntity39(BaseModel):
...
class CompensationModelsEntity40(BaseModel):
...
class CompensationModelsEntity41(BaseModel):
...
class CompensationModelsEntity42(BaseModel):
...
class CompensationModelsEntity43(BaseModel):
...
class CompensationModelsEntity44(BaseModel):
...
class CompensationModelsEntity45(BaseModel):
...
class CompensationModelsEntity46(BaseModel):
...
class CompensationModelsEntity47(BaseModel):
...
class CompensationModelsEntity48(BaseModel):
...
class CompensationModelsEntity49(BaseModel):
...
class CompensationModelsEntity50(BaseModel):
...
class CompensationModelsEntity51(BaseModel):
...
class CompensationModelsEntity52(BaseModel):
...
class CompensationModelsEntity53(BaseModel):
...
class CompensationModelsEntity54(BaseModel):
...
class CompensationModelsEntity55(BaseModel):
...
class CompensationModelsEntity56(BaseModel):
...
class CompensationModelsEntity57(BaseModel):
...
class CompensationModelsEntity58(BaseModel):
...
class CompensationModelsEntity59(BaseModel):

"""
PayBridge Enterprise Domain: Compensation - Module: Constants
...
class CompensationConstantsEntity1(BaseModel):
...
class CompensationConstantsEntity2(BaseModel):
...
class CompensationConstantsEntity3(BaseModel):
...
class CompensationConstantsEntity4(BaseModel):
...
class CompensationConstantsEntity5(BaseModel):
...
class CompensationConstantsEntity6(BaseModel):
...
class CompensationConstantsEntity7(BaseModel):
...
class CompensationConstantsEntity8(BaseModel):
...
class CompensationConstantsEntity9(BaseModel):
...
class CompensationConstantsEntity10(BaseModel):
...
class CompensationConstantsEntity11(BaseModel):
...
class CompensationConstantsEntity12(BaseModel):
...
class CompensationConstantsEntity13(BaseModel):
...
class CompensationConstantsEntity14(BaseModel):
...
class CompensationConstantsEntity15(BaseModel):
...
class CompensationConstantsEntity16(BaseModel):
...
class CompensationConstantsEntity17(BaseModel):
...
class CompensationConstantsEntity18(BaseModel):
...
class CompensationConstantsEntity19(BaseModel):
...
class CompensationConstantsEntity20(BaseModel):
...
class CompensationConstantsEntity21(BaseModel):
...
class CompensationConstantsEntity22(BaseModel):
...
class CompensationConstantsEntity23(BaseModel):
...
class CompensationConstantsEntity24(BaseModel):
...
class CompensationConstantsEntity25(BaseModel):
...
class CompensationConstantsEntity26(BaseModel):
...
class CompensationConstantsEntity27(BaseModel):
...
class CompensationConstantsEntity28(BaseModel):
...
class CompensationConstantsEntity29(BaseModel):
...
class CompensationConstantsEntity30(BaseModel):
...
class CompensationConstantsEntity31(BaseModel):
...
class CompensationConstantsEntity32(BaseModel):
...
class CompensationConstantsEntity33(BaseModel):
...
class CompensationConstantsEntity34(BaseModel):
...
class CompensationConstantsEntity35(BaseModel):
...
class CompensationConstantsEntity36(BaseModel):
...
class CompensationConstantsEntity37(BaseModel):
...
class CompensationConstantsEntity38(BaseModel):
...
class CompensationConstantsEntity39(BaseModel):
...
class CompensationConstantsEntity40(BaseModel):
...
class CompensationConstantsEntity41(BaseModel):
...
class CompensationConstantsEntity42(BaseModel):
...
class CompensationConstantsEntity43(BaseModel):
...
class CompensationConstantsEntity44(BaseModel):
...
class CompensationConstantsEntity45(BaseModel):
...
class CompensationConstantsEntity46(BaseModel):
...
class CompensationConstantsEntity47(BaseModel):
...
class CompensationConstantsEntity48(BaseModel):
...
class CompensationConstantsEntity49(BaseModel):
...
class CompensationConstantsEntity50(BaseModel):
...
class CompensationConstantsEntity51(BaseModel):
...
class CompensationConstantsEntity52(BaseModel):
...
class CompensationConstantsEntity53(BaseModel):
...
class CompensationConstantsEntity54(BaseModel):
...
class CompensationConstantsEntity55(BaseModel):
...
class CompensationConstantsEntity56(BaseModel):
...
class CompensationConstantsEntity57(BaseModel):
...
class CompensationConstantsEntity58(BaseModel):
...
class CompensationConstantsEntity59(BaseModel):

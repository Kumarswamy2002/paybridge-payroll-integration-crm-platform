"""
PayBridge Enterprise Domain: Security - Module: Schemas
...
class SecuritySchemasEntity1(BaseModel):
...
class SecuritySchemasEntity2(BaseModel):
...
class SecuritySchemasEntity3(BaseModel):
...
class SecuritySchemasEntity4(BaseModel):
...
class SecuritySchemasEntity5(BaseModel):
...
class SecuritySchemasEntity6(BaseModel):
...
class SecuritySchemasEntity7(BaseModel):
...
class SecuritySchemasEntity8(BaseModel):
...
class SecuritySchemasEntity9(BaseModel):
...
class SecuritySchemasEntity10(BaseModel):
...
class SecuritySchemasEntity11(BaseModel):
...
class SecuritySchemasEntity12(BaseModel):
...
class SecuritySchemasEntity13(BaseModel):
...
class SecuritySchemasEntity14(BaseModel):
...
class SecuritySchemasEntity15(BaseModel):
...
class SecuritySchemasEntity16(BaseModel):
...
class SecuritySchemasEntity17(BaseModel):
...
class SecuritySchemasEntity18(BaseModel):
...
class SecuritySchemasEntity19(BaseModel):
...
class SecuritySchemasEntity20(BaseModel):
...
class SecuritySchemasEntity21(BaseModel):
...
class SecuritySchemasEntity22(BaseModel):
...
class SecuritySchemasEntity23(BaseModel):
...
class SecuritySchemasEntity24(BaseModel):
...
class SecuritySchemasEntity25(BaseModel):
...
class SecuritySchemasEntity26(BaseModel):
...
class SecuritySchemasEntity27(BaseModel):
...
class SecuritySchemasEntity28(BaseModel):
...
class SecuritySchemasEntity29(BaseModel):
...
class SecuritySchemasEntity30(BaseModel):
...
class SecuritySchemasEntity31(BaseModel):
...
class SecuritySchemasEntity32(BaseModel):
...
class SecuritySchemasEntity33(BaseModel):
...
class SecuritySchemasEntity34(BaseModel):
...
class SecuritySchemasEntity35(BaseModel):
...
class SecuritySchemasEntity36(BaseModel):
...
class SecuritySchemasEntity37(BaseModel):
...
class SecuritySchemasEntity38(BaseModel):
...
class SecuritySchemasEntity39(BaseModel):
...
class SecuritySchemasEntity40(BaseModel):
...
class SecuritySchemasEntity41(BaseModel):
...
class SecuritySchemasEntity42(BaseModel):
...
class SecuritySchemasEntity43(BaseModel):
...
class SecuritySchemasEntity44(BaseModel):
...
class SecuritySchemasEntity45(BaseModel):
...
class SecuritySchemasEntity46(BaseModel):
...
class SecuritySchemasEntity47(BaseModel):
...
class SecuritySchemasEntity48(BaseModel):
...
class SecuritySchemasEntity49(BaseModel):
...
class SecuritySchemasEntity50(BaseModel):
...
class SecuritySchemasEntity51(BaseModel):
...
class SecuritySchemasEntity52(BaseModel):
...
class SecuritySchemasEntity53(BaseModel):
...
class SecuritySchemasEntity54(BaseModel):
...
class SecuritySchemasEntity55(BaseModel):
...
class SecuritySchemasEntity56(BaseModel):
...
class SecuritySchemasEntity57(BaseModel):
...
class SecuritySchemasEntity58(BaseModel):
...
class SecuritySchemasEntity59(BaseModel):
